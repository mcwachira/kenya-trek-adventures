...
import {CompanyFormValues, companySchema, RegionalFormValues, regionalSchema} from "@/lib/auth";
...
const DashboardSettings = () => {
  const { theme, setTheme } = useTheme();
    ...
    const handleRegionalSubmit = (values:RegionalFormValues) => {
        ...
        toast.success("Settings saved! Currency changes will reflect across the site.");
    };


    return (
        <div className="space-y-6">
            <h2 className="text-2xl font-bold text-green-800 dark:text-green-400">Dashboard Settings</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        <Form {...regionalForm}>
                            <form onSubmit={regionalForm.handleSubmit(handleRegionalSubmit)} className="space-y-4">
                                <FormField
