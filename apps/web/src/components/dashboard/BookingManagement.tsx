...
import { Calendar, Mail, Phone, User, Users, Filter, Download, Search, CheckCircle, Clock, XCircle, Trash2, CalendarIcon } from "lucide-react";
...
const BookingManagement = () => {
    ...
    const exportToCSV = () => {
        const headers = ['Name', 'Email', 'Phone', 'Service', 'Guests', 'Date', 'Status', 'Created'];
        const csvContent = [
            headers.join(','),
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h2 className="text-3xl font-bold text-green-800 dark:text-green-400">Booking Management</h2>
                    <p className="text-gray-600 dark:text-gray-300 mt-1">Manage all tour bookings and reservations</p>
                </div>
                <div className="flex gap-2">
                    ...
                    <Button onClick={exportToCSV} variant="outline" className="bg-green-50 hover:bg-green-100 text-green-700 border-green-200">
            ...
            {viewMode === "calendar" && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <Card className="shadow-lg border-green-100 dark:border-green-800">
                        <CardHeader>
                            <CardTitle className="text-green-800 dark:text-green-400">Booking Calendar</CardTitle>
                        </CardHeader>
                    ...
                    <Card className="shadow-lg border-green-100 dark:border-green-800">
                        ...
                        <CardContent>
                            {bookingsOnSelectedDate.length === 0 ? (
                                <p className="text-center text-gray-500 py-8">No bookings on this date</p>
                            ) : (
                                <div className="space-y-4">
                                    {bookingsOnSelectedDate.map((booking) => (
                                        <div key={booking.id} className="p-4 border rounded-lg">
                                            ...
                                            <p className="text-sm"><strong>Tour:</strong> {booking.service}</p>
            ...
            {viewMode === "table" && (
                <Card className="shadow-lg border-green-100 dark:border-green-800">
                    <CardHeader>
                        <CardTitle className="text-green-800 dark:text-green-400">All Bookings</CardTitle>
                    </CardHeader>
                    <CardContent>
                                                ...
                                                <TableCell>
                                                    <div className="flex gap-1">
                                                        ...
                                                        <Button
                                                            size="sm"
                                                            variant="outline"
                                                            onClick={() => updateStatus({ id: booking.id, status: 'pending' })}
