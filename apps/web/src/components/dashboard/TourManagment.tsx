...
const TourManagement = () => {
    ...
    const handleEditTour = (tour: Tour) => {
        ...
        setFormData({
            ...
            image: typeof tour.image === "string"
                ? tour.image
                : tour.image && "_type" in tour.image
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) =>
                                                setFormData({
                                                    ...formData,
                                                    price: parseFloat(e.target.value) || 0, // ensures a number
                                                })
                                            }
                                            placeholder="e.g., $850"
                                        />
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) =>
                                                setFormData({ ...formData, status: value as Tour["status"] })
                                            }
                                        >
                                ...
                                <TableBody>
                                    {filteredTours.map((tour) => (
                                        ...
                                        >
                                            ...
                                            <TableCell>
                                                <Badge className={getCategoryColor(tour.category || "unknown")}>
                                        ...
                                        {tour.image ? (
                                            ...
                                            <Image
                                                src={
                                                    typeof tour.image === "string"
                                                        ? tour.image
                                                        : "_type" in tour.image && tour.image._type === "image"
                                                            ? urlFor(tour.image).url()
